...
- NVIC Контроллер –это специальный аппаратный модуль внутри микроконтроллеров на базе Cortex-M, отвечающий за обработку исключений.
- EXTI Контроллером внешних прерываний/событий (interrupt) прерывания/события отвечает за взаимосвязь между внешними сигналами I/O и контроллером NVIC
